 ...
 * ============================================================================
 * $Author: testyang $
 * $Id: user.php 14644 2008-06-05 02:54:49Z testyang $
*/
...
$_LANG['profile_js']['mobile_empty'] = '请输入您的手机号码！';
$_LANG['profile_js']['mobile_error'] = '您输入的手机号码不正确！';
...
/* 会员密码找回 */
$_LANG['username_and_email'] = '请输入您注册时填写的手机号码，新密码将发至您的手机上：';
$_LANG['enter_new_password'] = '请输入您的新密码';
$_LANG['username_no_email'] = '您填写的用户名与手机号码不匹配，请重新输入！';
$_LANG['fail_send_password'] = '发送短信出错，请与管理员联系！';
$_LANG['send_success'] = '重置密码的短信已经发到您的手机：';
$_LANG['parm_error'] = '参数错误，请返回！';
$_LANG['edit_password_failure'] = '您输入的原密码不正确！';
$_LANG['edit_password_success'] = '您的新密码已设置成功！';
$_LANG['username_not_match_email'] = '用户名与手机号码不匹配，请重新输入！';
//JS语言项
...
$_LANG['img_type_list'] = '您可以上传以下格式的文件：<br />gif、jpg、png、word、excel、txt、zip、ppt、pdf、RAR<br />附件上传大小: 不大于2M。';
...
$_LANG['olduser'] = '<span style="line-height:20px;">提示：<br />尊敬的顾客，如果您曾经通过电话订购廿一客产品，你原有的会员数据已经导入到网站。如您收到过廿一客的短信通知，请您用短信中的用户名和密码登录；如果没有收到，请使用网站的<a href="user.php?act=get_password"><font color="#FF0000">找回密码</font></a>功能找回密码。';
