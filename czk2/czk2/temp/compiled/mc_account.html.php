...
<table width="100%">
  <tr style="height:22px;line-height:22px;vertical-align:middle;">
    ...
    <td>搜索范围：
	      从<input name="sdate" type="text" id="sdate" size="22" value='' readonly="readonly" /><input name="selbtn3" type="button" id="selbtn3" onclick="return showCalendar('sdate', '%Y-%m-%d', false, false, 'selbtn3');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/>
	      到<input name="edate" type="text" id="edate" size="22" value='' readonly="readonly" /><input name="selbtn4" type="button" id="selbtn4" onclick="return showCalendar('edate', '%Y-%m-%d', false, false, 'selbtn4');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/> 
	</td>
