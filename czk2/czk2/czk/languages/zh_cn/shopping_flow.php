 ...
 * ============================================================================
 * $Author: testyang $
 * $Id: shopping_flow.php 14481 2008-04-18 11:23:01Z testyang $
*/
...
$_LANG['min_money_in_cart'] = '您的消费少于最小金额！';
...
$_LANG['your_discount'] = '根据优惠活<font color=red>%s</font>，您可以享受折扣 %s';
$_LANG['no'] = '无';
...
$_LANG['flow_js']['country_not_null'] = '请您选择收货人所在城市！';
$_LANG['flow_js']['province_not_null'] = '请您选择收货人所在环线！';
$_LANG['flow_js']['city_not_null'] = '请您选择收货人所在区域！';
...
$_LANG['remember_order_number'] = '感谢您在廿一客订购蛋糕！您的订单已提交成功,请记住您的订单号';
$_LANG['back_home'] = '<a href="index.php">返回首页</a>';
$_LANG['goto_user_center'] = '<a href="user.php">我的廿一客</a>';
...
$_LANG['pay_points_not_enough'] = '您帐户的K金已不足！';
$_LANG['integral_not_enough_for_gifts'] = '输入不能少于兑换品K金数 %d';
$_LANG['integral_not_send_only'] = '对不起，本兑换品不单独配送！';
$_LANG['integral_to_pay'] = '本单将消费您';
$_LANG['complete_your_message'] = '请您去<a href="user.php?act=profile">我的廿一客</a>完善您的联系方式以方便联系您！';
