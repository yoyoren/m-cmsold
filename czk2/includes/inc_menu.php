...
if($_SESSION['admin_name']=="kefu")
{
	...
	$modules['19_eachday_count']['03_order_list1']='eachday_count.php?act=eachday_list';
}elseif($_SESSION['admin_name']=="chengang"){
	$modules['19_eachday_count']['01_order_list']='eachday_count.php?act=order_list';
}
elseif($_SESSION['admin_name']=="caiwu"){
...
$modules['18_moneycard_manage']['04_used_moneycards']='moneycard1.php?act=used_card';
$modules['19_eachday_count']['01_order_list']='eachday_count.php?act=order_list';
$modules['19_eachday_count']['02_cake_count']='eachday_count.php?act=cake_count';
$modules['19_eachday_count']['03_order_list1']='eachday_count.php?act=eachday_list';
$modules['21_users_manage']['01_user_mobile']='user.php?act=user_info';
$modules['20_bonus_manage']['01_bonus_maintain']='bonus.php?act=maintain';
$modules['20_bonus_manage']['02_bonus_affirm']='bonus.php?act=affirm';
}
?>
