...
function validate()
{
  ...
  validator.required("type_name",      "请输入储值卡描述");
  //validator.required("type_money",     "请输入储值卡面值");
  ...
  //validator.required("use_start_date",     "请选择储值卡使用起始日期");
  //validator.required("use_end_date",     "请选择储值卡使用失效日期");
...
{
	if(result>0)
	{document.getElementById('mc_name_msg').innerHTML="储值卡描述已存在，请重新输入";
