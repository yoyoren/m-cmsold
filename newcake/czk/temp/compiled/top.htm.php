...
<body>
<div id="header-div">
  <div id="logo-div"><img src="images/ecshop_logo.gif" /></div>
  <div id="submenu-div">
    <ul>
...
?>
    ...
    <li class="fix-spacer"><a href="web_order.php" target="main-frame">北京网络订单</a></li>
	<li class="fix-spacer"><a href="web_order2.php" target="main-frame">沪杭网络订单</a></li>
	<li class="fix-spacer"><a href="users2.php?act=list" target="main-frame">用户查询</a></li>
	<li class="fix-spacer"><a href="chuzhika_manage.php?act=list" target="main-frame">储值卡管理</a></li>-->
  </ul>
  <br class="clear" />
</div>
</body>
