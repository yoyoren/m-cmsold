...
$_LANG['18_moneycard_manage'] = '储值卡管理';

/*储值卡管理*/
$_LANG['01_moneycard_maintain']='储值卡维护';
$_LANG['02_moneycard_affirm']='储值卡生效';
$_LANG['03_moneycard_edit']='储值卡查看';
$_LANG['04_moneycard_account']='储值卡账户记录查询';
