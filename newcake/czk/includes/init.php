...
/* 取得当前ecshop所在的根目录 */
define('ROOT_PATH', str_replace('czk/includes/init.php', '', str_replace('\\', '/', __FILE__)));
...
require(ROOT_PATH . 'czk/includes/inc_constant.php');
require(ROOT_PATH . 'czk/includes/cls_ecshop.php');
require(ROOT_PATH . 'czk/includes/cls_error.php');
require(ROOT_PATH . 'czk/includes/lib_time.php');
require(ROOT_PATH . 'czk/includes/lib_common.php');
require(ROOT_PATH . 'czk/includes/lib_main.php');
require(ROOT_PATH . 'czk/includes/cls_exchange.php');
...
/* 初始化数据库类 */
require(ROOT_PATH . 'czk/includes/cls_mysql.php');
...
/* 初始化session */
require(ROOT_PATH . 'czk/includes/cls_session.php');
...
{
    include(ROOT_PATH . 'czk/includes/cls_captcha.php');
...
require(ROOT_PATH . 'czk/languages/' .$_CFG['lang']. '/admin/common.php');
require(ROOT_PATH . 'czk/languages/' .$_CFG['lang']. '/admin/log_action.php');

if (file_exists(ROOT_PATH . 'czk/languages/' . $_CFG['lang'] . '/admin/' . basename(PHP_SELF)))
{
    include(ROOT_PATH . 'czk/languages/' . $_CFG['lang'] . '/admin/' . basename(PHP_SELF));
}

if (!file_exists('czk/temp/caches'))
{
    @mkdir('czk/temp/caches', 0777);
    @chmod('czk/temp/caches', 0777);
}

if (!file_exists('czk/temp/compiled/admin'))
{
    @mkdir('czk/temp/compiled/admin', 0777);
    @chmod('czk/temp/compiled/admin', 0777);
}
...
/* 创建 Smarty 对象。*/
require(ROOT_PATH . 'czk/includes/cls_template.php');
$smarty = new cls_template;

$smarty->template_dir  = ROOT_PATH . 'czk/templates';
$smarty->compile_dir   = ROOT_PATH . 'czk/temp/compiled';
if ((DEBUG_MODE & 2) == 2)
{
