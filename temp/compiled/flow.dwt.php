...
?>
  ...
  <table  align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2" >
	 ...
	 <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_93579800_1390840876');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_93579800_1390840876']):
?>
            <tr height="40px">
              <td bgcolor="#F2F2F2" align="left"  style="padding-left:24px;">
                <?php if ($this->_var['goods_0_93579800_1390840876']['goods_id'] > 0 && $this->_var['goods_0_93579800_1390840876']['extension_code'] != 'package_buy'): ?>
                 <?php echo $this->_var['goods_0_93579800_1390840876']['goods_name']; ?>[<?php echo nl2br($this->_var['goods_0_93579800_1390840876']['goods_attr']); ?>]
                <?php endif; ?>
              </td>
              <td align="left" >
			  <img src="themes/default/images/flow/f_jian.png" align="absmiddle" style="cursor:pointer;vertical-align:middle;"  onclick="minus(<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>);">&nbsp;<input type="text" name="goods_number[<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>" value="<?php echo $this->_var['goods_0_93579800_1390840876']['goods_number']; ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>&nbsp;<img src="themes/default/images/flow/f_jia.png" align="absmiddle"  style="cursor:pointer;vertical-align:middle;" onclick="plus(<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>);">
			  </td>
              <td align="left"  > <font  face="Arial"><?php echo $this->_var['goods_0_93579800_1390840876']['goods_price']; ?></font> </td>
              <td align="left" ><label id="sub_<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>"></label></td>
			  <?php if ($this->_var['goods_0_93579800_1390840876']['goods_id'] == 61): ?>
			  <td>&nbsp;</td>
			 
			  <?php elseif ($this->_var['goods_0_93579800_1390840876']['goods_id'] == 60): ?>
			  <td>&nbsp;</td>
			 
			  <?php else: ?>
			  <td width="">&nbsp;
				
				是<input type="radio" maxlength="5" name="birthcard<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>" value="1" style="border:0;" onclick="yess(<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>)" checked  />
				否<input  type="radio" name="birthcard<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>" value="0" style="border:0;" onclick="nono(<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>)" />
				<input type="text" maxlength="8" name="card_message[]" id="birth<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>" onkeyup="checkce(<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>)" value="文字内容(八个字内)"  style="color:grey;width:120px;" onclick="disappear(<?php echo $this->_var['goods_0_93579800_1390840876']['goods_id']; ?>)"/>
			  </td>
			 <!-- <td>
				<img src="themes/default/images/flow/f_jian.png" align="absmiddle" style="cursor:pointer;vertical-align:middle;"  onclick="minuscanju(<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>);">
				<input type="text" name="canju_number[<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>]" id="canju_number_<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>" value="0" size="4" class="inputBg" style="text-align:center " readonly />&nbsp;
				<img src="themes/default/images/flow/f_jia.png" align="absmiddle"  style="cursor:pointer;vertical-align:middle;" onclick="pluscanju(<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>);">&nbsp;<span id="canjuyuan<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>"> 0</span>&nbsp;元
			  </td>-->
			  <?php endif; ?>
			  <script language="javascript">
			  function checkce(e)
              ...
              <td align="left" >
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods_0_93579800_1390840876']['rec_id']; ?>'; " class="f6">&nbsp;<img src="themes/default/images/flow/f_del.png"></a>
              </td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
	...
	function lijinka()
	{
        ...
        <table  width="100%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#F2F2F2">
            <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_93872000_1390840876');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_93872000_1390840876']):
?>
            <tr>
              <td width="250px">&nbsp;&nbsp;&nbsp;
          <a href="goods.php?id=<?php echo $this->_var['goods_0_93872000_1390840876']['goods_id']; ?>" target="_blank" class="fc"><?php echo $this->_var['goods_0_93872000_1390840876']['goods_name']; ?>[<?php echo nl2br($this->_var['goods_0_93872000_1390840876']['goods_attr']); ?>]</a>
              </td>
              <td width="195px"></td>
			  <td width="157px" align="left"><?php echo $this->_var['goods_0_93872000_1390840876']['goods_number']; ?></td>
              <td width="150px" align="left"><?php echo $this->_var['goods_0_93872000_1390840876']['formated_goods_price']; ?></td>
              <td  align="left"><?php echo empty($this->_var['goods_0_93872000_1390840876']['discount']) ? '0' : $this->_var['goods_0_93872000_1390840876']['discount']; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
      </div>
...
<input type="radio" id="bill" name="pay_id" value="4" class="hide1" />快钱&nbsp;<span name="bill" >&nbsp;</span>
	...
	<div class="imgShow">
		...
		<?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_93938100_1390840876');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_93938100_1390840876']):
?>
		<img src="themes/default/images/sgoods/<?php echo $this->_var['goods_0_93938100_1390840876']['goodsimg']; ?>.png" width="50" height="33" alt="" />
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</div>
    </div>
	<div class="donetext">
